...
def _sops_repo_impl(rctx):
    ...
    build_content = """
load("@masmovil_bazel_rules//toolchains/sops:toolchain.bzl", "sops_toolchain")
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@masmovil_bazel_rules//toolchains/sops:toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@masmovil_bazel_rules//toolchains/sops:toolchain_type"],
...
toolchain(
    ...
    toolchain_type = "@masmovil_bazel_rules//toolchains/sops:toolchain_type",
)
""".format(
