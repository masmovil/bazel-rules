...
def _helm_toolchain_impl(ctx):
    ...
    template_variables = platform_common.TemplateVariableInfo({
        ...
        "HELM_BIN_SHORT": binary.short_path,
    })
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@masmovil_bazel_rules//toolchains/helm:toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@masmovil_bazel_rules//toolchains/helm:toolchain_type"],
