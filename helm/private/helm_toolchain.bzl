...
def _helm_repo_impl(rctx):
    ...
    build_content = """
load("@masmovil_bazel_rules_test//helm/private:helm_toolchain.bzl", "helm_toolchain")
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@masmovil_bazel_rules_test//helm:helm_toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@masmovil_bazel_rules_test//helm:helm_toolchain_type"],
...
toolchain(
    ...
    toolchain_type = "@masmovil_bazel_rules_test//helm:helm_toolchain_type",
)
""".format(
            platform = platform,
