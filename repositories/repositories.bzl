...
load("@com_github_masmovil_bazel_rules//toolchains/gcloud:def.bzl", "gcloud_configure")
...
def repositories():
  ...
  native.register_toolchains(
    ...
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.8.0_linux_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.8.0_osx_toolchain",
