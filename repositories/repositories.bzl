...
def repositories():
  ...
  native.register_toolchains(
    ...
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.12.2_linux_toolchain_arm",
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.12.2_osx_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.12.2_osx_toolchain_arm",
    "@com_github_masmovil_bazel_rules//toolchains/kubectl:kubectl_linux_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/kubectl:kubectl_linux_arm_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/kubectl:kubectl_osx_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/kubectl:kubectl_osx_arm_toolchain",
