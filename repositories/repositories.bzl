...
def repositories():
  ...
  native.register_toolchains(
    ...
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.4.1_linux_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/helm-3:helm_v3.4.1_osx_toolchain",
