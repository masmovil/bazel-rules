...
def repositories():
  ...
  native.register_toolchains(
    ...
    "@com_github_masmovil_bazel_rules//toolchains/helm-2-16:helm_v2.16.7_linux_toolchain",
    "@com_github_masmovil_bazel_rules//toolchains/helm-2-16:helm_v2.16.7__osx_toolchain",
