...
def yq_repositories():
  http_file(
    ...
    urls = ["https://github.com/mikefarah/yq/releases/download/v4.35.1/yq_linux_amd64.tar.gz"],
  ...
  http_file(
    ...
    urls = ["https://github.com/mikefarah/yq/releases/download/v4.35.1/yq_linux_arm64.tar.gz"],
  ...
  http_file(
    ...
    urls = ["https://github.com/mikefarah/yq/releases/download/v4.35.1/yq_darwin_amd64.tar.gz"],
  ...
  http_file(
    ...
    urls = ["https://github.com/mikefarah/yq/releases/download/v4.35.1/yq_darwin_arm64.tar.gz"],
