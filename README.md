...
This repository contains Bazel rules to manipulate and operate Helm charts with Bazel, decrpyt sops secrets, and run some operations on cloud services.
 ...
 ## Helm
 - [helm_chart](docs/helm_chart.md) Package a helm chart into a targz archive modifying its values and configuration
 ...
 - [helm_release](docs/helm_release.md) Installs or upgrades a helm chart in to a cluster using helm binary toolchain.
...
## k8s
- [k8s_namespace](docs/k8s_namespace.md) Create a kubernetes namespace in a kubernetes cluster with workload identity support. You can also configure GKE Workload Identity with it.
