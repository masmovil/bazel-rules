...
def _k8s_namespace_impl(ctx):
    kubectl_bin = ctx.toolchains["@masorange_rules_helm//k8s:kubectl_toolchain_type"].kubectlinfo.bin
    gcloud_bin = ctx.toolchains["@masorange_rules_helm//gcs:gcloud_toolchain_type"].gcloudinfo.gcloud_bin
...
k8s_namespace = rule(
    ...
    doc = _DOC,
    toolchains = [
      "@masorange_rules_helm//gcs:gcloud_toolchain_type",
      "@masorange_rules_helm//k8s:kubectl_toolchain_type",
    ],
    executable = True,
)
