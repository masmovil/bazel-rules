...
def _kubectl_repo_impl(rctx):
    ...
    build_content = """
load("@masmovil_bazel_rules_test//k8s/private:kubectl_toolchain.bzl", "kubectl_toolchain")
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@masmovil_bazel_rules_test//k8s:kubectl_toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@masmovil_bazel_rules_test//k8s:kubectl_toolchain_type"],
...
toolchain(
    ...
    toolchain_type = "@masmovil_bazel_rules_test//k8s:kubectl_toolchain_type",
)
""".format(
            platform = platform,
